...
for (client_name, data) in clients.items():
    ...
    #clients_batched[client_name] = batch_data2(x_train,y_train)
...
global_model.compile(loss='mean_squared_error', optimizer='adam',metrics =['mean_absolute_error'])
...
for comm_round in range(comms_round):
    ...
    for client in client_names:
        ...
        local_model.compile(loss='mean_squared_error', optimizer='adam',metrics = ['mean_absolute_error'])
